...
root.tk.call('wm', 'iconphoto', root._w, PhotoImage(file='C:/Users/user/Downloads/FacialRecognition/FacialRecognition/face-id.png'))
...
def recognition():
    ...
    def recognition_display():
        ...
        for(x,y,w,h) in faces:
            ...
            found = str(names[id])
            if(conf>20):
                NamesID = NamesID + ": "+ found
                msgLabelHome['text'] = "FaceCount :"+str(faceCount)+" Recognised as " + NamesID
                print("faceName: ", NamesID)
...
image = Image.open('C:/Users/user/Downloads/FacialRecognition/FacialRecognition/logo-main.png')
